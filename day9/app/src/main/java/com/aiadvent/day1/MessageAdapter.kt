    ...
    class MessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(message: Message) {
            ...
            if (message.role == "assistant") {
                ...
                with(message.tokensDetails!!) {
                    tokensInputView.text = "Запрос (оценка количества токенов): $estimatedInput"
                    tokensInputView.visibility = View.VISIBLE

                    tokensOutputView.text = "Ответ (оценка количества токенов): $estimatedOutput"
                    tokensOutputView.visibility = View.VISIBLE

                    tokensApiView.text = "Общее количество токенов из API: $actual"
