...
class ChatViewModel : ViewModel() {
    ...
    private fun estimateTokens(text: String, language: String = "en"): Int {
    ...
    private fun calculateTokenDetails(userInput: String, answer: String, response: Response<YandexGptResponse>): TokenDetails {
        // 1. Считаем оценки
        val estimatedTokensInput = estimateTokens(userInput, language = "en")
        val estimatedTokensOutput = estimateTokens(answer, language = "en")
