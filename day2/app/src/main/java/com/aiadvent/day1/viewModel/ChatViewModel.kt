...
class ChatViewModel : ViewModel() {
    ...
    private fun buildRequest(userInput: String): YandexGptRequest {
        return YandexGptRequest(
            ...
            messages = listOf(
                Message(role = "system", text = "Structured JSON response mode enabled. All AI responses need to be strictly in JSON format without ''' symbol." +
                        "It should contain field called response with response from you and field msToReply with quantity of milliseconds taken to reply." +
                        "Always delete three quotation marks at the beginning and end of the json object."),
